...
<div class="table-responsive rounded-2 mb-4">
    ...
    <table class="table border text-nowrap customize-table mb-0 align-middle">
      ...
      <tbody>
        @forelse ($topAdvertising as $key => $item)
        <tr>
            <td>
            ...
            <td class="text-end">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="">
                    ...
                    <li>
                    <a class="dropdown-item d-flex align-items-center gap-3" onclick="return confirm('Are you wnat to delete?')"  href="{{ route('topAdvertisingDelete', $item->id) }}"><i class="fs-4 ti ti-trash"></i>Delete</a>
                    </li>
                </ul>
                </div>
            </td>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content border-0">
                <div class="modal-header bg-primary">
                  <h6 class="modal-title text-white">Edit Top Advertising</h6>
                  <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('topAdvertisingEdit')}}" method="post" id="addnotesmodalTitle" enctype="multipart/form-data">
                  @csrf
                              ...
                              <div class="row">
                                  <div class="col-md-12 mb-3">
                                    <div class="note-title mt-3">
                                        ...
                                        @enderror
                                        <img src="{{ asset('storage/PopUp/') }}/{{ $item->image }}" class="img-fluid rounded-top" id="image_preview{{ $item->id }}" alt="image Preview" width="50" height="50" />
                                        <script>
    ...
    {{ $topAdvertising->links() }}
    <div class="modal" id="addData">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content border-0">
            <div class="modal-header bg-primary">
              <h6 class="modal-title text-white">Add Top Advertising</h6>
              <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('topAdvertisingPost') }}" method="POST" id="addnotesmodalTitle" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="notes-box">
                        <div class="notes-content">
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="note-title mt-3">
                                        ...
                                        @error('image','insert')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                        <img src="#" class="img-fluid rounded-top" id="image_preview" alt="image Preview" width="50" height="50" />
                                    </div>
                                 </div>
                            </div>
                        </div>
