...
<div class="table-responsive rounded-2 mb-4">
    ...
    <table class="table border text-nowrap customize-table mb-0 align-middle">
      ...
      <tbody>
        @forelse ($webinars as $key => $item)
        <tr>
            <td>
                <span>{{$webinars->firstItem()+$key}}</span>
            </td>
            ...
            <td class="text-end">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="">
                    ...
                    <li>
                    <a class="dropdown-item d-flex align-items-center gap-3" onclick="return confirm('Are you wnat to delete?')"  href="{{ route('webinarDelete', $item->id) }}"><i class="fs-4 ti ti-trash"></i>Delete</a>
                    </li>
                </ul>
                </div>
            </td>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content border-0">
                <div class="modal-header bg-primary">
                  <h6 class="modal-title text-white">Edit Webinar</h6>
                  <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('webinarEdit')}}" method="post" id="addnotesmodalTitle" enctype="multipart/form-data">
                  @csrf
    ...
    <div class="modal" id="addData">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content border-0">
            <div class="modal-header bg-primary">
              <h6 class="modal-title text-white">Add Webinar</h6>
              <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('webinarPost') }}" method="POST" id="addnotesmodalTitle" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="notes-box">
                        <div class="notes-content">
