    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-8">
                <form action="http://127.0.0.1:8000/api/admission-web" method="post" enctype="multipart/form-data" class="text-start" id="admissionForm">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 mt-3 align-self-center">
                                <div>
                                    <select id="gender" name="gender" class="form-select shadow-none form-select-lg">
                            ...
                            <div class="col-12 col-md-6 mt-3 align-self-center">
                                <div>
                                    <select id="course" name="course" class="form-select shadow-none form-select-lg">
                            ...
                            <div class="col-12 mt-3">
                                <div class="form-floating">
                                    <input type="file" class="form-control shadow-none" name="image" id="image" style="padding-top: 19px;">
                                    <label for="image" class="p-0"></label>
