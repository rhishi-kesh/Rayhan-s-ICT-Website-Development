                    ...
                    <table cellpadding='0' cellspacing='0' class='es-content' align='center'>
                        <tr>
                            <td align='center' style='padding:0;Margin:0'>
                                <table bgcolor='#efefef' class='es-content-body' align='center' style='border-collapse:collapse;border-spacing:0px;background-color:#EFEFEF;border-radius:20px 20px 0 0;width:600px'>
                                    <tr>
                                        <td align='left'
                                                        ...
                                                        <table cellpadding='0' cellspacing='0' width='100%'>
                                                            <tr>
                                                                <td align='left' style='padding:20px;Margin:0'>
                                                                    ...
                                                                    <p style='Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;font-family:Imprima, Arial, sans-serif;line-height:27px;color:#2D3142;font-size:18px'>
                                                                        We're delighted to inform you that we've successfully received your request for the upcoming webinar. The webinar is scheduled to take place on {{ $details['date'] }} at {{ $details['time'] }}. If this timing doesn't align with your schedule, one of our executives will contact you shortly to discuss alternative options. <br> <br>
                                                                        Thank you for expressing interest in attending our webinar, and we eagerly anticipate your participation. <br><br>
                                                                        Best regards, <br>
