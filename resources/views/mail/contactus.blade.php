                        ...
                        <table cellpadding='0' cellspacing='0' width='100%'>
                            <tr>
                                <td align='center' valign='top'
                                    style='padding-top:20px;Margin:0;width:520px'>
                                    <table cellpadding='0' cellspacing='0' width='100%'>
                                        <tr>
                                            <td align='left' style='padding:20px;Margin:0'>
                                                <p style='Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;font-family:Imprima, Arial, sans-serif;line-height:27px;color:#2D3142;font-size:18px'>
                                                    Dear Communications Officer, <br> <br>
                                                    I hope this message finds you well. My name is {{ $details['name'] }}, and I am reaching out to you regarding {{ $details['subject'] }}. <br> <br>
                                                    {{ $details['massage'] }} <br> <br>
                                                    If possible, I would appreciate a response at your earliest convenience. You can reach me at {{ $details['email'] }} or {{ $details['number'] }}. <br> <br>
                                                    Thank you for your time and attention to this matter. I look forward to hearing from you soon. <br> <br>
                                                    Best regards, <br>
                                                    {{ $details['name'] }} <br>
                                                    {{ $details['number'] }}
                                                </p>
